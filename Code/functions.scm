...
(define (evaluate-board player)
 ...
 (define (helper player) ;evaluates board for the particular player
  ...
  (- (* 6 (helper player))
     (+  (helper (vector-ref all-balls (get-n-ind i)))
         (helper (vector-ref all-balls (get-n-ind (get-n-ind i))))
         (helper (vector-ref all-balls (get-n-ind (get-n-ind (get-n-ind i))))))))))
         ;(helper (vector-ref all-balls (modulo (+ i 4) 6)))
         ;(helper (vector-ref all-balls (modulo (+ i 5) 6)))
